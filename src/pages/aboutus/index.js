        ...
        <Grid container spacing={2} sx={{marginTop:1,}}>
          ...
          <Grid item xs={12} sm={6} md={6} lg={6}>
            <Box sx={{ lineHeight: 2, justifyContent: "space-between" }}>
              ...
              <Typography variant="body1" sx={{ lineHeight: 2, justifyContent: "space-between" }}>
              ...
              <br />
                ...
                <br/> After
                completing the training program, dedicated placement The group
                ensures that the candidates get employment in various textile
                sectors and also facilitates them for self-employment.<br/> Also,
                work To expand the scope of opportunities, increase the
                recruitment partner support system and new employment
                opportunities Investigate A typical job mapping activity is done
                at the central level.<br/> Indira Skill Trust works with NSDC, SSCs
          ...
          <Grid item xs={12} sm={12} md={12} lg={12}>
            <Box>
              ...
              The main mission of Sikaram Skills Foundation in the field of
                ...
                youth in India.<br/> In JET skills Ensures holistic development of
                trainees. Along with technical skills, JET skills training
                focuses on other dimensions of skill development— Numerical
                Ability, Science, Basic Information Technology, Career
                Orientation, Communication, Soft Skills & Personality
                Development and Work Ethics and Gives special importance.
                Considering the specific requirement of Safety, Health and
                Environment (SHE) sector.<br/> We firmly believe that future training
                includes the skills, abilities and learning attitudes needed to
                succeed in the future. A growing international movement focused
                on the skills students need to master in preparation for success
                in a rapidly changing, digital society This is in part. Many of
                these skills are related to deep learning, such as analytical
                reasoning, complex problem solving, and teamwork Based on
                mastering skills.<br/> These skills differ from traditional academic
                skills because they are not primarily based on content
                knowledge.
              </Typography>
            </Box>
            <Typography variant="h3" sx={{ lineHeight: 2 }}>Mission Statement:</Typography>
            <Typography variant="body1" sx={{ lineHeight: 2 }}>
            ...
            creativity, and personal growth.<br/> Our commitment to excellence
            extends to the following key principles:<br/> 1. **Educational
