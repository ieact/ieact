     ...
     <>
              ...
              <Toolbar>
                <Hidden mdUp>
                  ...
                  <Drawer anchor="left" open={menuOpen} onClose={toggleMenu}>
                    ...
                    <DrawerHeader>
          <IconButton onClick={handleDrawerClose}>  <ChevronLeftIcon/>
        ...
        <Divider />
                    ...
                    >
                      ...
                      <a href=''>
                      <Button onClick={toggleMenu}>Courses</Button></a>
                      <a href=''>
                      <Button onClick={toggleMenu}>Affiliation-PIA</Button></a>  
                ...
                <Stack direction={"row"} spacing={2}>
                  ...
                  <Link href="/">
                    <Button  sx={{fontSize:"1.2rem", color:'warning.dark','&:hover': {color:'secondary.dark'} }}>Home</Button>
                  </Link>
                 
                  <Link href="/aboutus">
                    <Button sx={{fontSize:"1.2rem",color:'warning.dark', '&:hover': {color:'secondary.dark'} }}>About-Us</Button>
                  </Link>
                  <ProjectHover/>
                 <CoursesHover/>
                  <Button  sx={{fontSize:"1.2rem", color:'warning.dark','&:hover': {color:'secondary.dark'} }}>Affiliation-PIA</Button>
                 
                  <Link href="/contactform/contact">
                    <Button   sx={{fontSize:"1.2rem", color:'warning.dark','&:hover': {color:'secondary.dark'} }}>Contact-Us</Button>
                  </Link>
                  </Stack>
                </Hidden>
              </Toolbar>
